...
//   url     https://ucp.dev/2026-04-08/schemas/shopping/types/reverse_domain_name.json
//   version 2026-04-08
//
// Transforms applied:
...
/** `reverse_domain_name` pattern for UCP 2026-04-08, verbatim from the spec. */
export const reverseDomainPattern: RegExp = new RegExp("^[a-z][a-z0-9]*(?:\\.[a-z][a-z0-9_]*)+$")
